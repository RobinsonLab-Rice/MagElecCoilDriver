...
/*
 * init(uint8_t xtal_load_c, uint32_t ref_osc_freq, int32_t corr, int32_t SDAPin, int32_t SCLPin)
 * 
 * Same as init with fewer parameters, but uses alternative I2C pins and speed
 *
*/
bool Si5351::init2(uint8_t xtal_load_c, uint32_t xo_freq, int32_t corr, uint8_t wire_select)
{
	// Start I2C comms
	if (wire_select == 0)	{
		wire = Wire;
